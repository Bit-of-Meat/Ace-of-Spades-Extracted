...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\pkg_resources
from __future__ import absolute_import
import sys, os, io, time, re, imp, zipfile, zipimport, warnings, stat, functools, pkgutil, token, symbol, operator, platform, collections, plistlib, email.parser, tempfile, textwrap
...
try:
    import pkg_resources._vendor.packaging.version, pkg_resources._vendor.packaging.specifiers
...
__all__ = [
 ...
 'safe_extra', 'to_filename', 'invalid_marker', 
 'evaluate_marker', 
 'ensure_directory', 'normalize_path', 
 'EGG_DIST', 
 'BINARY_DIST', 'SOURCE_DIST', 'CHECKOUT_DIST', 'DEVELOP_DIST', 
 'IMetadataProvider', 
 'IResourceProvider', 'FileMetadata', 
 'PathMetadata', 'EggMetadata', 'EmptyProvider', 
 'empty_provider', 
 'NullProvider', 'EggProvider', 'DefaultProvider', 'ZipProvider', 
 'register_finder', 
 'register_namespace_handler', 'register_loader_type', 
...
class MarkerEvaluation(object):
    ...
    def normalize_exception(exc):
        subs = {'unexpected EOF while parsing': 'invalid syntax', 
...
# okay decompiling out\pkg_resources.pyc
