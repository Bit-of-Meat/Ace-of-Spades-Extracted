...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\pkg_resources._vendor.packaging.specifiers
...
class SpecifierSet(BaseSpecifier):
    ...
    def filter(self, iterable, prereleases=None):
        ...
        if not filtered and found_prereleases and prereleases is None:
            ...
            return filtered
            return
# okay decompiling out\pkg_resources._vendor.packaging.specifiers.pyc
