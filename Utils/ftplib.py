...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\ftplib
import os, sys
try:
    import SOCKS
    socket = SOCKS
...
if __name__ == '__main__':
    test()
# okay decompiling out\ftplib.pyc
