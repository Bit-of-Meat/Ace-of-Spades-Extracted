...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\threading
import sys as _sys
try:
    import thread
except ImportError:
...
if __name__ == '__main__':
    _test()
# okay decompiling out\threading.pyc
