...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\urllib2
...
class CacheFTPHandler(FTPHandler):
    ...
    def clear_cache(self):
        ...
        self.cache.clear()
        self.timeout.clear()
# okay decompiling out\urllib2.pyc
