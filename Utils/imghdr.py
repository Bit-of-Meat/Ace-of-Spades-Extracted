...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\imghdr
__all__ = [
 'what']
    ...
    for filename in list:
        if os.path.isdir(filename):
            ...
            try:
                ...
                print '*** not found ***'
# okay decompiling out\imghdr.pyc
