...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\unittest.suite
import sys
from . import case
from . import util
__unittest = True
...
class _DebugResult(object):
    ...
    shouldStop = False
# okay decompiling out\unittest.suite.pyc
