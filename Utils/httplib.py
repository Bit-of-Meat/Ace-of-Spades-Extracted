...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\httplib
...
class LineAndFileWrapper():
    ...
    def readlines(self, size=None):
        if self._line_consumed:
            ...
            return
# okay decompiling out\httplib.pyc
