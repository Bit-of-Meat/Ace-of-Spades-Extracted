...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\traceback
...
def tb_lineno(tb):
    return tb.tb_lineno
# okay decompiling out\traceback.pyc
