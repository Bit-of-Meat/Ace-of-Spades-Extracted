...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\unittest.case
...
class FunctionTestCase(TestCase):
    ...
    def shortDescription(self):
        if self._description is not None:
            ...
            return doc and doc.split('\n')[0].strip() or None
# okay decompiling out\unittest.case.pyc
