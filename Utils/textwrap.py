...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\textwrap
__revision__ = '$Id$'
import string, re
try:
    _unicode = unicode
...
# okay decompiling out\textwrap.pyc
