...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\sre_constants
MAGIC = 20031017
try:
...
if __name__ == '__main__':
    ...
    f.close()
    print 'done'
# okay decompiling out\sre_constants.pyc
