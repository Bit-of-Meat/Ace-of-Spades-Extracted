...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\distutils.spawn
__revision__ = '$Id$'
import sys, os
...
def find_executable(executable, path=None):
    ...
    return executable
    return
# okay decompiling out\distutils.spawn.pyc
