...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\doctest
...
if __name__ == '__main__':
    sys.exit(_test())
# okay decompiling out\doctest.pyc
