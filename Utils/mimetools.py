...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\mimetools
...
def copybinary(input, output):
    ...
    while 1:
        ...
        if not line:
            break
        output.write(line)
# okay decompiling out\mimetools.pyc
