...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\socket
import _socket
from _socket import *
...
def create_connection(address, timeout=_GLOBAL_DEFAULT_TIMEOUT, source_address=None):
    ...
    return
# okay decompiling out\socket.pyc
