...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\_osx_support
import os, re, sys
__all__ = [
 'compiler_fixup',
...
# okay decompiling out\_osx_support.pyc
