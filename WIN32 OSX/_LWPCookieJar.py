...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\_LWPCookieJar
import time, re
...
class LWPCookieJar(FileCookieJar):
    ...
    def _really_load(self, f, filename, ignore_discard, ignore_expires):
        ...
        return
# okay decompiling out\_LWPCookieJar.pyc
