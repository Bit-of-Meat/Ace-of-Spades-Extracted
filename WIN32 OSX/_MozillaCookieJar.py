...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\_MozillaCookieJar
import re, time
...
class MozillaCookieJar(FileCookieJar):
    ...
    def save(self, filename=None, ignore_discard=False, ignore_expires=False):
        ...
        return
# okay decompiling out\_MozillaCookieJar.pyc
