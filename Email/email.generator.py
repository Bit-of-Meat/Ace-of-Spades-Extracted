...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\email.generator
__all__ = [
...
def _make_boundary(text=None):
    ...
    if text is None:
        ...
        return b
# okay decompiling out\email.generator.pyc
