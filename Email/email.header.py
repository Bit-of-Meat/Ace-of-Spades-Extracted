...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\email.header
__all__ = [
 'Header',
 'decode_header',
 'make_header']
...
def _binsplit(splittable, charset, maxlinelen):
    ...
    return (first, last)
# okay decompiling out\email.header.pyc
