...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\email.feedparser
__all__ = [
 'FeedParser']
import re
...
# okay decompiling out\email.feedparser.pyc
