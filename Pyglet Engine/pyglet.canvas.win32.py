...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\pyglet.canvas.win32
...
class Win32Canvas(Canvas):
    ...
    def __init__(self, display, hwnd, hdc):
        ...
        self.hwnd = hwnd
        self.hdc = hdc
# okay decompiling out\pyglet.canvas.win32.pyc
