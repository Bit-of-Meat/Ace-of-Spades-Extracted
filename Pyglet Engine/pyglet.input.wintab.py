...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\pyglet.input.wintab
...
def get_tablets(display=None):
    ...
    return devices
# okay decompiling out\pyglet.input.wintab.pyc
