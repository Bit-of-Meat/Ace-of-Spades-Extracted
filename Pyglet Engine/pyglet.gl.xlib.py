...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\pyglet.gl.xlib
...
class BaseXlibCanvasConfig(CanvasConfig):
    attribute_ids = {'buffer_size': glx.GLX_BUFFER_SIZE, 'level': glx.GLX_LEVEL, 
...
# okay decompiling out\pyglet.gl.xlib.pyc
