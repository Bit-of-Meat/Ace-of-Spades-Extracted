...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\pyglet.input.x11_xinput_tablet
__docformat__ = 'restructuredtext'
__version__ = '$Id: $'
import pyglet
from pyglet.input.base import Tablet, TabletCanvas, TabletCursor, DeviceOpenException
from pyglet.input.x11_xinput import get_devices, XInputWindowEventDispatcher, DeviceResponder
try:
...
def get_tablets(display=None):
    ...
    return []
# okay decompiling out\pyglet.input.x11_xinput_tablet.pyc
