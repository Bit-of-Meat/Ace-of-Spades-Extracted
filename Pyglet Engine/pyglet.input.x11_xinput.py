...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\pyglet.input.x11_xinput
__docformat__ = 'restructuredtext'
__version__ = '$Id: $'
import ctypes, pyglet
from pyglet.input.base import Device, DeviceException, DeviceOpenException, Control, Button, RelativeAxis, AbsoluteAxis
...
def _check_extension(display):
    ...
    xlib.XQueryExtension(display._display, 'XInputExtension', ctypes.byref(major_opcode), ctypes.byref(first_event), ctypes.byref(first_error))
...
def get_devices(display=None):
    ...
    return devices
# okay decompiling out\pyglet.input.x11_xinput.pyc
