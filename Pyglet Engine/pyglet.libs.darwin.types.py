...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\pyglet.libs.darwin.types
...
class TabletPointRec(Structure):
    _fields_ = (
     ...
     (
      'vendor3', c_int16))
# okay decompiling out\pyglet.libs.darwin.types.pyc
