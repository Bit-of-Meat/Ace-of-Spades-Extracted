...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\pyglet.gl.win32
...
class Win32ARBContext(Win32Context):
    ...
    def attach(self, canvas):
        ...
        return
# okay decompiling out\pyglet.gl.win32.pyc
