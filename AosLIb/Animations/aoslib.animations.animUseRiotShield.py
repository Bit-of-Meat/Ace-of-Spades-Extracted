...
# Embedded file name: C:\TeamCity\buildAgent\work\dc8eb0b1d2cf198a\Main\client\standalone\build\pyi.win32\run_obfuscated\out00-PYZ.pyz\aoslib.animations.animUseRiotShield
...
class AnimUseRiotShield(Animation):
    ...
    def update(self, dt):
        ...
        if super(AnimUseRiotShield, self).update(dt):
            ...
            return False
# okay decompiling out\aoslib.animations.animUseRiotShield.pyc
